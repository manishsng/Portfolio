...
//        _buildNavigationArrows(),
  ...
  Widget _buildEducationSummary() {
    return Text(
      'I am an undergrad student majoring in Computer Science and Engineering from Indraprastha University, Delhi. I have done Freelance graphic Designing and Web Developement for few Companies. Currently, i am  making Result Analyser for my university.',
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/manish-singh-684753ba/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://medium.com/@manish.bk07", "Medium");
          },
          child: Image.network(
            Assets.evernote,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/manishsng", "Github");
          },
          child: Image.network(
            Assets.google,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://twitter.com/sngmanish", "Twitter");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
